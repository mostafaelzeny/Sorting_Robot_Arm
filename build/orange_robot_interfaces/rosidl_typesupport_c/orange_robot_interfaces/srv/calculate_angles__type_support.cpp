...
static const _CalculateAngles_Request_type_support_symbol_names_t _CalculateAngles_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, orange_robot_interfaces, srv, CalculateAngles_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orange_robot_interfaces, srv, CalculateAngles_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, orange_robot_interfaces, srv, CalculateAngles_Request)() {
  return &::orange_robot_interfaces::srv::rosidl_typesupport_c::CalculateAngles_Request_message_type_support_handle;
}
...
static const _CalculateAngles_Response_type_support_symbol_names_t _CalculateAngles_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, orange_robot_interfaces, srv, CalculateAngles_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orange_robot_interfaces, srv, CalculateAngles_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, orange_robot_interfaces, srv, CalculateAngles_Response)() {
  return &::orange_robot_interfaces::srv::rosidl_typesupport_c::CalculateAngles_Response_message_type_support_handle;
}
...
static const _CalculateAngles_type_support_symbol_names_t _CalculateAngles_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, orange_robot_interfaces, srv, CalculateAngles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orange_robot_interfaces, srv, CalculateAngles)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, orange_robot_interfaces, srv, CalculateAngles)() {
  return &::orange_robot_interfaces::srv::rosidl_typesupport_c::CalculateAngles_service_type_support_handle;
}
